...
"C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin\msbuild.exe" src/DotNet/DotNet.Jenkins/DotNet.Jenkins.csproj "/p:Platform=AnyCPU;Configuration=Release;PublishDestination=E:/published" /t:PublishToFileSystem
